...
/*   Updated: 2023/04/26 20:25:09 by emcnab           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Seperate test to check parse_whitespace's behavior with a NULL parameter
Test(parse_whitespace_suite, parse_whitespace_null)
{
	static char	*null = NULL;
	char		*str_dst;

	str_dst = parse_whitespace(null);
	cr_log_info(MSG_FORMAT_RES, null, str_dst);
	cr_assert_eq(
		str_dst, null,
		MSG_FORMAT_INV_STR,
		null, null, str_dst);
